        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="${pageContext.request.contextPath}/UserUpdateServlet" method="post">
                        <fieldset>
                            <input type="hidden" name="id" value="${user.id}">
                            <div class="form-group">
                                <input class="form-control" placeholder="账户名" name="username"  value="${user.username}" autofocus>
                            </div>
                            <div class="form-group">
